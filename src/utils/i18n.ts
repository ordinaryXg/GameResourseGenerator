export const i18n = {
  zh: {
    app: { title: 'FX Studio', new: '+ 新建', import: '导入', save: '保存', templates: '模板库', export: '导出', settings: '设置', preview: '预览', back: '← 返回编辑器' },
  ...
  en: {
    app: { title: 'FX Studio', new: '+ New', import: 'Import', save: 'Save', templates: 'Templates', export: 'Export', settings: 'Settings', preview: 'Preview', back: '← Back' },
