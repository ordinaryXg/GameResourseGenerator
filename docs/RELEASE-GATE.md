...
| # | 验收项 | 验证方式 | 状态 |
|---|--------|----------|------|
| 1 | 可创建含 3+ Emitter 的组合特效 | E2E A2 | ☐ |
| 2 | 层级树拖拽 reparent + Undo | E2E A3 · `project-history.test` | ☐ |
| 3 | 内置贴图 ≥10 张 | `builtin-assets-files.test` | ☐ |
| 4 | Inspector 换贴图预览 <1s | E2E A4 | ☐ |
| 5 | 多 ParticleSystem Cocos 导出 | `export-composite.test` · E2E A6 | ☐ |
| 6 | 多节点 prefab 导入 | `prefab-importer.test` · E2E C1 | ☐ |
| 7 | 无历史 Tab；Ctrl+Z/Y | 手工 · `project-history.test` | ☐ |
| 8 | AI 可隐藏且全流程可用 | E2E B1 | ☐ |
| 9 | v1 Session 迁移 | `migrate-v1.test` · E2E D1 | ☐ |
